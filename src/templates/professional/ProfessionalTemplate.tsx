  ...
  return (
    <ResumeContainer>
      ...
      <RightSection>
        ...
        {/* <SectionValidator
                    value={skills.languages.concat(skills.frameworks)}
                >
                    <Section title="Technical expertise">
                        <RatedSkills
                            items={skills.languages.concat(skills.frameworks)}
                        />
                    </Section>
                </SectionValidator> */}

        <SectionValidator
          value={skills.technologies?.concat(
            skills.libraries,
            skills.databases,
          )}
        >
          <Section title="Skills / Exposure">
            <UnratedSkills
              items={skills.technologies?.concat(
                skills.libraries,
                skills.databases,
              )}
            />
